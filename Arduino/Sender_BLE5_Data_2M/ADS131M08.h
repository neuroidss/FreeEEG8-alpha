...
// Uncomment this define to enable DMA-backed SPI transfers for bulk ADC data reads.
// This uses SPIClass::transferBytes, which on ESP32 typically uses DMA.
// This may improve stability and performance for high-speed data acquisition.
#define USE_DMA_FOR_ADC_READ 
...
#define REGMASK_STATUS_DRDY7 0x0080
#define REGMASK_STATUS_DRDY6 0x0040
#define REGMASK_STATUS_DRDY5 0x0020
#define REGMASK_STATUS_DRDY4 0x0010
...
// Mask Register GAIN
#define REGMASK_GAIN_PGAGAIN7 0x7000
#define REGMASK_GAIN_PGAGAIN6 0x0700
#define REGMASK_GAIN_PGAGAIN5 0x0070
#define REGMASK_GAIN_PGAGAIN4 0x0007
