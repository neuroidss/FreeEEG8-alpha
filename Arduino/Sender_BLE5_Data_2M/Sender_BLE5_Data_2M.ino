...
void setup() {
    ...
    // ЗОЛОТАЯ СЕРЕДИНА МОЩНОСТИ: +3 dBm (было N12, то есть -12 dBm)
    // Это даст уверенные 5-10 метров без скачков тока по питанию
    ...
    class MyServerCallbacks : public NimBLEServerCallbacks {
        void onConnect(NimBLEServer* pServer, NimBLEConnInfo& connInfo) override {
            ...
            // Минимальный интервал 7.5мс (6 * 1.25мс), чтобы пакеты улетали сразу
